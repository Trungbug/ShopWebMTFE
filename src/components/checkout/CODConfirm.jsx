...
import { codPaymentConfirmation } from '../../store/actions';
    ...
    useEffect(() => {
        if (paymentIntent &&
            ...
            const sendData = {
                ...
                pgPaymentId: "N/A",
                pgStatus: "pending",
                pgResponseMessage: "Order will be paid on delivery"
            };
            console.log(sendData);
            dispatch(codPaymentConfirmation(sendData, setErrorMessage, setLoading, toast));
        }
